# SYMBIO AI - COMPLETE STARTUP GUIDE
...
### Foundational Systems (7 systems)
...
### Example: Recursive Self-Improvement Demo Output
...
**Deep documentation:** 6. **docs/whitepaper.md** - Comprehensive technical whitepaper (1,) 7. **docs/automated_theorem_proving.md** - Theorem proving details 8. **docs/recursive_self_improvement.md** - Meta-evolution details 9. **docs/\*.md** - 18+ system-specific guides
...
6. **Check examples folder** - All demos are ~200-, easy to read
...
**Total time:** ~20 minutes for complete first experience
...
Code: 75,Performance: Industry-leading across all metrics
