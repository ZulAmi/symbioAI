...
def register_model() -> None:
    """
    Write a thin shim into mammoth/models/derpp_causal.py so Mammoth's
    os.listdir('models') discovers 'derpp-causal'.

    The shim is ephemeral (lives only in the local mammoth/ working tree,
    not committed to the submodule). Safe to re-create on every run.
    """
    shim = (
        "# Auto-generated by run_optimized_true_causality.py — do not edit.\n"
        "# Registers DerppCausal with Mammoth's model discovery system.\n"
